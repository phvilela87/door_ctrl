...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TIME_5_GND_Pin|OUTPUT_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = TIME_5_GND_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TIME_5_GND_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = TIME_1_Pin|TIME_10_Pin|TIME_5_Pin|TIME_3_Pin;
